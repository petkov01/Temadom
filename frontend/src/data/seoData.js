...
export const SEO_PROFESSIONS = [
  ...
  { id: "tiler", name: "Фаянсаджия", slug: "fayansdzhiya", searchTerms: ["плочки", "фаянс", "гранитогрес"], basePrice: { labor: 12, full: 22 }, unit: "м²" },
  { id: "electrician", name: "Електротехник", slug: "elektrotehnik", searchTerms: ["ел. инсталация", "контакти", "осветление"], basePrice: { labor: 8, full: 14 }, unit: "точка" },
  { id: "plumber", name: "Водопроводчик", slug: "vodoprovodchik", searchTerms: ["ВиК", "водопровод", "канализация"], basePrice: { labor: 10, full: 18 }, unit: "точка" },
  ...
  { id: "roofer", name: "Покривджия", slug: "pokrivdzhiya", searchTerms: ["покрив", "ремонт покрив", "керемиди"], basePrice: { labor: 15, full: 35 }, unit: "м²" },
  { id: "mason", name: "Зидар", slug: "zidar", searchTerms: ["зидане", "тухли", "стени"], basePrice: { labor: 10, full: 18 }, unit: "м²" },
  { id: "screed", name: "Замазчик", slug: "zamazchik", searchTerms: ["замазка", "циментова замазка", "подове"], basePrice: { labor: 14, full: 30 }, unit: "м²" },
  { id: "insulation", name: "Изолатор", slug: "izolator", searchTerms: ["топлоизолация", "стиропор", "фасада"], basePrice: { labor: 12, full: 28 }, unit: "м²" },
  { id: "waterproof", name: "Хидроизолатор", slug: "hidroizolator", searchTerms: ["хидроизолация", "баня", "тераса"], basePrice: { labor: 8, full: 16 }, unit: "м²" },
  { id: "drywall", name: "Гипскартонист", slug: "gipskartонist", searchTerms: ["гипсокартон", "окачен таван", "преградни стени"], basePrice: { labor: 12, full: 22 }, unit: "м²" },
  ...
  { id: "concrete", name: "Бетонджия", slug: "betondzhiya", searchTerms: ["бетон", "фундамент", "плоча"], basePrice: { labor: 25, full: 50 }, unit: "м³" },
  { id: "excavation", name: "Изкопни работи", slug: "izkopni-raboti", searchTerms: ["изкопаване", "основи", "нивелиране"], basePrice: { labor: 10, full: 18 }, unit: "м³" },
  { id: "facade", name: "Фасаден работник", slug: "fasaden-rabotnik", searchTerms: ["фасада", "мазилка фасада", "декоративна мазилка"], basePrice: { labor: 10, full: 25 }, unit: "м²" },
