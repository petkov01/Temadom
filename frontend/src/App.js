...
import { 
  ...
  ChevronRight, CheckCircle, AlertCircle, Clock, ArrowRight, Shield, Users, Award, Check, Calculator, Camera, ChevronLeft, Image
} from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <div className="inline-flex items-center gap-2 bg-orange-500/20 border border-orange-500/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-orange-300 font-medium">Безплатен инструмент</span>
              </div>
              ...
              <p className="text-xl text-slate-300 mb-8">
                Нашият интелигентен калкулатор ви помага да планирате бюджета си с реални пазарни цени от България.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">28 категории услуги</h4>
                    <p className="text-slate-400">От боядисване до изкопни работи и басейни</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">Цени по региони</h4>
                    <p className="text-slate-400">Различни цени за София, Пловдив, Варна и още 6 града</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">3 нива качество</h4>
                    <p className="text-slate-400">Икономичен, Стандартен или Премиум - изберете според бюджета</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">Труд или труд + материали</h4>
                    <p className="text-slate-400">Изберете дали сами осигурявате материалите</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-slate-500 text-white hover:bg-slate-700 text-lg px-8"
                  onClick={() => navigate('/register')}
                >
                  Публикувай проект
                </Button>
            ...
            {/* Right side - Mini Calculator Preview */}
              ...
              <Card className="bg-white/10 backdrop-blur border-white/20 p-6 rounded-2xl">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-2 border-b border-white/10">
                    <span className="text-slate-300">Боядисване (160 м²)</span>
                    <span className="text-white font-medium">1,104 €</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-white/10">
                    <span className="text-slate-300">Шпакловка (160 м²)</span>
                    <span className="text-white font-medium">1,288 €</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-white/10">
                    <span className="text-slate-300">Подови настилки (80 м²)</span>
                    <span className="text-white font-medium">3,680 €</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-white/10">
                    <span className="text-slate-300">Ел. инсталация (30 точки)</span>
                    <span className="text-white font-medium">1,725 €</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-white/10">
                    <span className="text-slate-300">ВиК инсталация (6 точки)</span>
                    <span className="text-white font-medium">759 €</span>
                  </div>
                </div>
                
                <div className="bg-orange-600 rounded-xl p-4 text-center">
                  <p className="text-orange-100 text-sm mb-1">Приблизителна цена</p>
                  <p className="text-3xl font-bold text-white">8,556 €</p>
                  <p className="text-orange-200 text-sm">≈ 16,684 лв.</p>
                </div>
                
                <p className="text-slate-500 text-xs text-center mt-4">
                  * Стандартно качество, труд + материали
                </p>
              </Card>
            </div>
          </div>
