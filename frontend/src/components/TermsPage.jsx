    ...
    <div className="min-h-screen" style={{background: "var(--theme-bg-secondary)"}} data-testid="terms-page">
      ...
      <section className="bg-slate-900 text-white py-14">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="theme-text-muted">Последна актуализация: февруари 2026</p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 theme-text-muted leading-relaxed">
        ...
        <div className="text-center theme-text-subtle text-sm pt-8">
