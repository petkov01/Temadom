...
const RegionalPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="regional-page">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          <Card><CardContent className="p-4 text-center"><p className="text-2xl font-bold text-orange-600">x{region.multiplier.toFixed(2)}</p><p className="text-xs text-slate-500">Ценови коефициент</p></CardContent></Card>
          <Card><CardContent className="p-4 text-center"><p className="text-2xl font-bold text-slate-900">28</p><p className="text-xs text-slate-500">Професии</p></CardContent></Card>
          <Card><CardContent className="p-4 text-center"><p className="text-2xl font-bold text-slate-900">{region.population}</p><p className="text-xs text-slate-500">Население</p></CardContent></Card>
        ...
        {/* Full price table */}
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Всички цени в {region.name} за 2026</h2>
        ...
        {/* Example calculation */}
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Примерна калкулация за апартамент 60 м² в {region.name}</h2>
          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-lg">
                <span className="font-bold text-slate-900">ОБЩА СУМА</span>
        ...
        <div className="text-center mb-8">
          <Link to="/calculator">
            <Button className="bg-orange-600 hover:bg-orange-700 text-lg px-8 py-3" data-testid="region-calc-btn">
        ...
        {/* Other regions */}
        <h2 className="text-xl font-bold text-slate-900 mb-4">Сравни с други области</h2>
        <div className="grid sm:grid-cols-3 md:grid-cols-4 gap-3">
          {otherRegions.slice(0, 8).map(([k, r]) => (
            <Link key={k} to={`/region/${r.slug}`} className="text-sm text-orange-600 hover:underline flex items-center gap-1">
